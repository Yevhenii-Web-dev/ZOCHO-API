...
<div
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="flex items-center justify-center flex-col pt-8 sm:justify-start sm:pt-0">
            ...
            <h1 class="text-xl font-bold text-red-700 text-uppercase">ZOHO API CONNECT</h1>
        </div>
            ...
            <div class="grid ">
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    ...
                    <div class="mt-10 flex justify-center">
                        <form method="POST" action="{{route('generate.generateAccessToken')}} ">
                            @csrf
                            <button type="submit"
